    ...
    >
      ...
      {!fullscreen && preview && (
        <div
          ...
          style={{
            ...
            opacity: loaded ? 0 : 1, // fade out when video loads
          }}
        />
      )}
      ...
      {!fullscreen && blurhash && (
        <Blurhash
          hash={blurhash}
          className={clsx(
            'absolute left-0 top-0 z-20 size-full rounded-lg object-cover transition-opacity duration-500 ease-linear dark:bg-gray-900',
            { 'opacity-0': loaded },
          )}
        />
      )}
      ...
      <video
        ...
        onCanPlay={() => setLoaded(true)} // ensures video is ready before fade
            ...
            >
              ...
              <span
                className={clsx(
                  ...
                  { 'opacity-100': volumeHovered, 'bottom-[23px]': fullscreen || detailed },
                )}
                tabIndex={0}
